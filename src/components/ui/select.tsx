...
>(({ className, children, position = "popper", ...props }, ref) => {
  // Desestrutura onInteractOutside e onPointerDownOutside para evitar que cheguem ao DOM
